...
function Header() {
  return (
    <header className="text-gray-600 body-font shadow-lg relative">
      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center relative z-10">
        ...
        <button className="inline-flex items-center bg-indigo-500 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-700 rounded text-white mt-4 md:mt-0">
          Go To Cart
